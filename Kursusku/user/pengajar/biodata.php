...
<div class="container">
  <div class="page-header text-center" style="margin-top: 70px">
	...
	<div class="container">
		...
		$queri="Select * From pengajar where email_pengajar='$username'" ;
	...
	<div class="col-sm-8">
		<table class="table">
			<tr>
				<td>Nama</td><td>:</td><td><?php echo $row['nama_pengajar'] ?></td>
			</tr>
			<tr>
				<td>Email</td><td>:</td><td><?php echo $row['email_pengajar'] ?></td>
			</tr>
			<tr>
				<td>Jenis Kelamin</td><td>:</td><td><?php echo $row['jenis_kelamin_pengajar'] ?></td>
			</tr>
			<tr>
				<td>Alamat</td><td>:</td><td><?php echo $row['alamat_pengajar'] ?></td>
			</tr>
			<tr>
				<td>Tangal Lahir</td><td>:</td><td><?php echo $row['tgl_lahir_pengajar'] ?></td>
			</tr>
			<tr>
				<td>No. Telp</td><td>:</td><td><?php echo $row['no_telp_pengajar'] ?></td>
			</tr>
			<tr>
				<td>Nama Mapel</td><td>:</td><td><?php echo $row['nama_mapel'] ?></td>
			</tr>
			</table>
</div>
